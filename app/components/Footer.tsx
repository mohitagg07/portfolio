...
export default function Footer(): React.JSX.Element {
  const socials = [
    {
      href: "https://instagram.com/mohitagg07",
      title: "Instagram",
    ...
    {
      href: "https://github.com/mohitagg07",
      title: "GitHub",
    ...
    {
      href: "https://linkedin.com/in/mohitagg07",
      title: "LinkedIn",
      bg: "linear-gradient(135deg, #0077B5 0%, #005885 100%)",
      shadow: "rgba(0,119,181,0.45)",
      icon: (
        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="border-t" style={{ borderColor: "rgba(255,255,255,0.05)", padding: "48px 0" }}>
      <div className="container-fluid" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24, position: "relative", zIndex: 10 }}>
        ...
        <div className="flex items-center gap-4">
          {socials.map((s) => (
            <a
              ...
              style={{
                background: s.bg,
                boxShadow: `0 4px 15px ${s.shadow}`,
              }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = `0 8px 24px ${s.shadow}`;
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = `0 4px 15px ${s.shadow}`;
              }}
            >
              {s.icon}
            </a>
        ...
        {/* Copyright */}
        <p className="text-white/30 text-sm font-[family-name:var(--font-outfit)]">
          © 2026 Mohit Agarwal. All rights reserved.
        </p>
      </div>
    </footer>
  );
